...
predictions_table_mixed <- data.frame(median = c(exp(as.numeric(abc_rf_mixed_predictions[[1]]$prediction$med)),
                                           ...
                                           exp(as.numeric(abc_rf_mixed_predictions[[5]]$prediction$med))),
                                low_quant = c(exp(as.numeric(abc_rf_mixed_predictions[[1]]$prediction$quantiles[1])),
                                              inv_logit(as.numeric(abc_rf_mixed_predictions[[2]]$prediction$quantiles[1]), logit_bounds),
                                              inv_logit(as.numeric(abc_rf_mixed_predictions[[3]]$prediction$quantiles[1]), logit_bounds),
                                              exp(as.numeric(abc_rf_mixed_predictions[[4]]$prediction$quantiles[1])),
                                              exp(as.numeric(abc_rf_mixed_predictions[[5]]$prediction$quantiles[1]))),
                                high_quant = c(exp(as.numeric(abc_rf_mixed_predictions[[1]]$prediction$quantiles[2])),
                                               inv_logit(as.numeric(abc_rf_mixed_predictions[[2]]$prediction$quantiles[2]), logit_bounds),
                                               inv_logit(as.numeric(abc_rf_mixed_predictions[[3]]$prediction$quantiles[2]), logit_bounds),
                                               exp(as.numeric(abc_rf_mixed_predictions[[4]]$prediction$quantiles[2])),
                                               exp(as.numeric(abc_rf_mixed_predictions[[5]]$prediction$quantiles[2]))),
                                rmsle = c(sqrt(as.numeric(abc_rf_mixed_predictions[[1]]$OOB_MSE)),
                                          sqrt(as.numeric(abc_rf_mixed_predictions[[2]]$OOB_MSE)),
                                          sqrt(as.numeric(abc_rf_mixed_predictions[[3]]$OOB_MSE)),
                                          sqrt(as.numeric(abc_rf_mixed_predictions[[4]]$OOB_MSE)),
                                          sqrt(as.numeric(abc_rf_mixed_predictions[[5]]$OOB_MSE))))
